...
const addressList = [
    { iconName: 'icofont-google-map', text: 'India, Kolkata.', },
    { iconName: 'icofont-phone', text: '+91 70012 72388', },
    { iconName: 'icofont-envelope', text: 'swarupmahata321@gmail.com', },
]
        ...
        <footer className='style-2'>
            <div className="footer-top dark-view padding-tb">
                <div className="container">
                    <div className="row g-4 justify-content-center row-cols-xl-4 row-cols-sm-2 row-cols-1">
                        <div className="col">
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2024 <Link to="/">Shop Cart</Link>Design by <a href="/" target='_blank'>Swarup</a></p>
